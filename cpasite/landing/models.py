...
class Allinstanceprice(models.Model):
...
class Awsprice(models.Model):
    instance_name = models.CharField(db_column='Instance_name', max_length=20, blank=True, null=True)  # Field name made lowercase.
    linux_price = models.FloatField(db_column='Linux_Price', blank=True, null=True)  # Field name made lowercase.
    windows_price = models.FloatField(db_column='Windows_Price', blank=True, null=True)  # Field name made lowercase.
    vcpu = models.IntegerField(db_column='vCPU', blank=True, null=True)  # Field name made lowercase.
    memory = models.FloatField(blank=True, null=True)
...
class Azureprice(models.Model):
    instance_name = models.CharField(db_column='Instance_name', max_length=40, blank=True, null=True)  # Field name made lowercase.
    linux_price = models.FloatField(db_column='Linux_Price', blank=True, null=True)  # Field name made lowercase.
    windows_price = models.FloatField(db_column='Windows_Price', blank=True, null=True)  # Field name made lowercase.
    vcpu = models.IntegerField(db_column='vCPU', blank=True, null=True)  # Field name made lowercase.
    memory = models.IntegerField(db_column='Memory', blank=True, null=True)  # Field name made lowercase.
    storage = models.IntegerField(db_column='Storage', blank=True, null=True)  # Field name made lowercase.
    instance_family = models.CharField(db_column='Instance_Family', max_length=40, blank=True, null=True)  # Field name made lowercase.
    region = models.CharField(db_column='Region', max_length=40, blank=True, null=True)  # Field name made lowercase.
...
class Gcpprice(models.Model):
    instance_name = models.CharField(db_column='Instance_name', max_length=40, blank=True, null=True)  # Field name made lowercase.
    instance_price = models.FloatField(db_column='Instance_Price', blank=True, null=True)  # Field name made lowercase.
    vcpu = models.IntegerField(db_column='vCPU', blank=True, null=True)  # Field name made lowercase.
    memory = models.IntegerField(db_column='Memory', blank=True, null=True)  # Field name made lowercase.
    instance_family = models.CharField(db_column='Instance_Family', max_length=40, blank=True, null=True)  # Field name made lowercase.
    region = models.CharField(db_column='Region', max_length=40, blank=True, null=True)  # Field name made lowercase.
